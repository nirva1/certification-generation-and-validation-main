        ...
        <>    <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet" />
            ...
            <div className="lg:grid lg:grid-cols-2 md:grid md:grid-cols-2 gap-4 bg-[#000010] h-[100vh]">
                ...
                <p className='lg:text-[30px] text-[35px] font-bold text-[white]'>Certificate generation and validation</p>
                    <h1 className="text-[25px] font-semibold my-6 text-[white]">Admin Login</h1><br />
                    ...
                    <form className="max-w-sm">
                        ...
                        <h1 className='text-[white]'>New user? <Link to="/admin/signup" className="font-bold underline">Signup</Link></h1>
                        <h1 className='text-[white]'>User? <Link to="/login" className="font-bold underline">Login</Link></h1>
                    </form>
                </div>
            </div>
